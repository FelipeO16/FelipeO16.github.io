<template>
  <div class="container">
    <div class="stacks">
      ...
      <!-- <button @click="api.getResponse('frontend', 'pt')">pt</button> -->
    </div>
  </div>
</template>
...
<style scoped>
/* .stacks {
  @apply w-full h-full flex flex-col justify-center gap-8 items-center;
} */
...
.stacks {
  ...
  @apply flex flex-col items-center w-full lg:w-10/12 py-8 px-4;
}
